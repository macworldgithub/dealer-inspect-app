...
export default function ServiceIntake({ navigation }) {
  const workflows = [
    {
      id: 1,
      title: "Service Protection Inspection",
      subtitle: "Document vehicle condition before service",
      screen: "ServiceProtection", // ← navigation screen name
    },
    {
      id: 2,
      title: "Reconditioning Inspection",
      subtitle: "Track reconditioning progress and quality",
      screen: "Reconditioning",
    },
    {
      id: 3,
      title: "Trade-In Valuation",
      subtitle: "AI-powered trade-in assessment",
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={tw`mx-6 mb-6 bg-white rounded-3xl p-6 shadow-lg`}>
          <Text style={tw`text-xl font-bold text-black`}>
            Service Intake & Valuation
          </Text>
          <Text style={tw`text-gray-600 text-base mt-2`}>
            Select your workflow to begin the inspection process
          </Text>
